...
app.put('/api/bookings/:id', async (req, res) => {
    ...
    if (idx !== -1) {
        ...
        if (updateData.customerName !== undefined)
            booking.customerName = updateData.customerName;
        if (updateData.mobileNumber !== undefined)
            booking.mobileNumber = updateData.mobileNumber;
        if (updateData.date !== undefined)
            booking.date = updateData.date;
        if (updateData.location !== undefined)
            booking.location = updateData.location;
        if (updateData.eventType !== undefined)
            booking.eventType = updateData.eventType;
        ...
        if (updateData.paymentScreenshot !== undefined)
            booking.paymentScreenshot = updateData.paymentScreenshot;
